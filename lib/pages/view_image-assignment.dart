...
class ViewFileAssignmentPage extends StatefulWidget {
  final String assignmentId;
  final String fileName;
  ViewFileAssignmentPage({required this.assignmentId, required this.fileName});

  @override
  _ViewFileAssignmentPageState createState() => _ViewFileAssignmentPageState();
}

class _ViewFileAssignmentPageState extends State<ViewFileAssignmentPage> {
  String _localPath = '';
  String _fileType = '';
